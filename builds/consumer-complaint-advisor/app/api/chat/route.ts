...
import * as analyzeComplaint from '@/lib/tools/analyze-complaint'
import * as searchConsumerRights from '@/lib/tools/search-consumer-rights'
import * as researchCompanyComplaints from '@/lib/tools/research-company-complaints'
import * as writeResolutionPlan from '@/lib/tools/write-resolution-plan'
...
function ensureTools() {
  ...
  registerTool(analyzeComplaint)
  registerTool(searchConsumerRights)
  registerTool(researchCompanyComplaints)
  registerTool(writeResolutionPlan)
