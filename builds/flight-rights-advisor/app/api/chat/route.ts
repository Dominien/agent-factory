...
import * as analyzeFlightDisruption from '@/lib/tools/analyze-flight-disruption'
import * as searchAirlineRights from '@/lib/tools/search-airline-rights'
import * as researchAirlineRecord from '@/lib/tools/research-airline-record'
import * as writeClaimPlan from '@/lib/tools/write-claim-plan'

let toolsRegistered = false
function ensureTools() {
  if (toolsRegistered) return
  registerTool(analyzeFlightDisruption)
  registerTool(searchAirlineRights)
  registerTool(researchAirlineRecord)
  registerTool(writeClaimPlan)
