...
import * as searchRegulations from '@/lib/tools/search-regulations'
import * as fetchRegulatoryDetails from '@/lib/tools/fetch-regulatory-details'
import * as writeComplianceBriefing from '@/lib/tools/write-compliance-briefing'
...
function ensureTools() {
  ...
  registerTool(searchRegulations)
  registerTool(fetchRegulatoryDetails)
  registerTool(writeComplianceBriefing)
